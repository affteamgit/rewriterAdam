            ...
            try:
                response = client.chat.completions.create(
                    ...
                    messages=[
                        ...
                        {"role": "user", "content": f"Rewrite this review in Adam's tone, style, and voice SECTION BY SECTION. Do not change or add the factual content, only focus on the style and tone of voice of the input facts:\n\n{content}"}
                    ]
                )
